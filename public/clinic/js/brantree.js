    ...
    function r(t) {
        ...
        for (a in t.merchantConfiguration) t.merchantConfiguration.hasOwnProperty(a) && "paypal" !== a && (t.merchantConfiguration.paypal[a] = t.merchantConfiguration[a]);
            y.call(this, t), e = this.configuration.merchantConfiguration, n = i(e), r = o(e), f = p(e.paypal.onCancelled) ? e.paypal.onCancelled : function() {}, (n || r) && (e.paypal.onSuccess = h(function(t) {
                ...
                v = null, f && f()
            }, this.paypalIntegration = l.create(this.configuration), this.destructor.registerFunctionForTeardown(h(function() {
        ...
        (function(n) {
            ...
            function i(t, e, i) {
                ...
                i = i || {}, s = p.uuid(), r._getConfiguration({
                    ...
                    var f;
                    return r ? (f = h(i)(u.ROOT_ERROR_CALLBACK, l), void f({
                        message: r.errors
                    })) : void new c[e]({
                        channel: s,
                        authorization: t,
...
191: [function(t, e, n) {
    (function(n) {
        ...
        s.prototype.initialize = function() {
            ...
            this.frames.modal.element.style.position = r() ? "absolute" : "fixed", this.frames.modal.element.style.top = "0", this.frames.modal.element.style.left = "0", this.frames.modal.element.style.height = "100%", this.frames.modal.element.style.width = "100%"
    ...
    210: [function(t, e, n) {
        (function(n) {
            ...
            i.prototype.initialize = function() {
                ...
                e = e || {}, t.type === v.NONCE_TYPE && e.offerPaypalCredit === o && s(i) && i(t)
...
213: [function(t, e, n) {
    (function(n) {
        ...
        i.prototype._initialize = function() {
            ...
            var n = Boolean(this.options.offerPaypalCredit);
            e = e || {}, t.type === u.NONCE_TYPE && e.offerPaypalCredit === n && this.close()
...
215: [function(t, e, n) {
    (function(n) {
        ...
        i.prototype._initialize = function() {
            ...
            var n, i = Boolean(this.options.offerPaypalCredit);
            e && e.offerPaypalCredit === i && t.type === l.NONCE_TYPE && (n = t && t.details && t.details.email ? t.details.email : "", this.show(n))
        }, i.prototype._handlePaymentMethodCancelled = function(t) {
...
216: [function(t, e, n) {
    (function(n) {
        ...
        i.prototype._initialize = function() {
            ...
            var n = Boolean(this.options.offerPaypalCredit);
            e && e.offerPaypalCredit === n && t.type === s.NONCE_TYPE && this.hide()
        }, i.prototype._handlePaymentMethodCancelled = function(t) {
...
220: [function(t, e, n) {
    (function(n) {
        ...
        i.prototype._initialize = function() {
            ...
            var n = Boolean(this.options.offerPaypalCredit);
            e = e || {}, t.type === u.NONCE_TYPE && e.offerPaypalCredit === n && this.value(t.nonce)
        }, i.prototype.teardown = function() {
